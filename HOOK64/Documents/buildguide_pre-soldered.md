...
HOOK64は液晶タブレットに設置して使用することに主眼開発したキーボードです。  

写真は作成見本であり商品内容と同一ではありません。  
また仕様は予告なく変更されることがあります。  

ファームウェアに[qmk_firmware](https://github.com/qmk/qmk_firmware)を採用しています。  
QMKにHOOK64のコードはマージされていませんのでこの[ブランチ](https://github.com/kushima8/qmk_firmware/tree/hook)を使用してください。  
動作確認の為のコンパイル済みファームウェアを[HEXファイル](https://github.com/kushima8/HOOK64-HOOK49/tree/main/HOOK64/HEX)と[UF2ファイル](https://github.com/kushima8/HOOK64-HOOK49/tree/main/HOOK64/UF2)を用意しています。  
